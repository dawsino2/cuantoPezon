...
namespace Proxies\__CG__\ICM06\CuantoPezonBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Noticia extends \ICM06\CuantoPezonBundle\Entity\Noticia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'idNoticia', 'titulo', 'descripcion', 'fecha', 'like', 'imagen');
        }
